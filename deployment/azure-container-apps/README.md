...
Both image scripts resolve the source directories automatically (`../../services/` and `../../apps/priceprovider/` relative to this folder), so they can be run from any working directory.
