...
## Option 3 - Step 4: PriceTypeDefinition Interface

The definition interface extends `EnumTypeValueDefinition<T>` to provide a standard way to retrieve the value object.
...
The registry extends `EnumTypeValueRegistry<T, D>` to handle common logic like case-insensitive lookups and duplicate detection during initialization.
