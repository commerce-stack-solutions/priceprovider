...
/**
 * Validation rule that ensures Language.name contains values for all mandatory languages.
 * This ensures that language names are available in all languages marked as mandatory.
 */
@Component
