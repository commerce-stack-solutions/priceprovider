...
@Component
public class OrganizationEntityMapper extends AbstractMapper<OrganizationRestEntity, OrganizationEntity, RestRequestMappingContext<UUID>> {
    ...
    @Override
    public void convert(OrganizationRestEntity source, OrganizationEntity target, RestRequestMappingContext<UUID> context) throws DataMappingException {
