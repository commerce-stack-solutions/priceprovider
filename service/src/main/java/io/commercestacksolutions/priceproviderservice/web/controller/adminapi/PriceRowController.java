...
public class PriceRowController {
    ...
    @PreAuthorize("@permissionSecurityService.hasPermissionForAction('PriceRow', 'write')")
    @PutMapping("/{id}")
    ...
    @PreAuthorize("@permissionSecurityService.hasPermissionForAction('PriceRow', 'delete')")
    @DeleteMapping("/{id}")
