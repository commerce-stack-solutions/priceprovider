...
public class InvalidParameterException extends Exception {
    ...
    public InvalidParameterException(String messageKey) {
        super(messageKey);
    ...
    public InvalidParameterException(String messageKey, List<String> fields) {
        super(messageKey);
    ...
    public InvalidParameterException(String messageKey, Map<String, String> parameters) {
        super(messageKey);
    ...
    public InvalidParameterException(String messageKey, Map<String, String> parameters, List<String> fields) {
        super(messageKey);
    ...
    public InvalidParameterException(String messageKey, ErrorResponse errorResponse) {
        super(messageKey);
