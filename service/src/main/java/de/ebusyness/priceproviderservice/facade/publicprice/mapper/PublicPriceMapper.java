package de.ebusyness.priceproviderservice.facade.publicprice.mapper;
...
import de.ebusyness.priceproviderservice.facade.currency.mapper.CurrencyRestEntityMapper;
import de.ebusyness.priceproviderservice.facade.publicprice.info.InfoPublicPrice;
import de.ebusyness.priceproviderservice.facade.publicprice.info.OriginalPriceInfo;
import de.ebusyness.priceproviderservice.facade.publicprice.info.TaxationInfo;
import de.ebusyness.priceproviderservice.facade.publicprice.restentity.IncludesPublicPrice;
import de.ebusyness.priceproviderservice.facade.publicprice.restentity.PublicPriceRestEntity;
import de.ebusyness.priceproviderservice.facade.taxclass.mapper.TaxClassRestEntityMapper;
import de.ebusyness.priceproviderservice.facade.unit.mapper.UnitRestEntityMapper;
import de.ebusyness.priceproviderservice.service.publicprice.model.PriceMatchingCriteria;
import de.ebusyness.priceproviderservice.service.publicprice.strategy.TaxRoundingStrategy;
...
public class PublicPriceMapper extends AbstractMapper<PriceRowEntity, PublicPriceRestEntity, RestResponseMappingContext> {
    ...
    public void convert(PriceRowEntity source, PublicPriceRestEntity target, RestResponseMappingContext context) throws DataMappingException {
        ...
        if (source.getChannels() != null) {
            ...
            for (de.ebusyness.priceproviderservice.dataaccess.channel.entity.ChannelEntity channel : source.getChannels()) {
