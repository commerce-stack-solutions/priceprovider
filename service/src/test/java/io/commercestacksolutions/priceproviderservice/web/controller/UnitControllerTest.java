...
public class UnitControllerTest {
    ...
    public void testBulkDeleteUnitsWithDataIntegrityViolation() throws Exception {
        org.mockito.Mockito.doThrow(new io.commercestacksolutions.commons.exception.DataIntegrityException("Cannot delete unit - it is still referenced by other entities"))
