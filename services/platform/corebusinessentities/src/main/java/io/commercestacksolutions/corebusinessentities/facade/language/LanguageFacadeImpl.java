package io.commercestacksolutions.corebusinessentities.facade.language;
...
import io.commercestacksolutions.corebusinessentities.facade.language.mapper.LanguageEntityMapper;
import io.commercestacksolutions.corebusinessentities.facade.language.mapper.LanguageRestEntityMapper;
...
public class LanguageFacadeImpl implements LanguageFacade {
    ...
    public LanguageListRestEntity createOrUpdateAllLanguages(List<LanguageRestEntity> languageRestEntities) {
        ...
        List<LanguageRestEntity> results = new ArrayList<>();
