...
This directory contains the comprehensive documentation for the services platform and its service applications.
...
│
├── 010-architecture/
│   ├── 010-overview.md                       Architecture overview, layer description, goals, constraints, extension mechanisms
│   ├── 020-architectural-decisions.md        ADR index and purpose
│   ├── 021-adr001.md                         ADR-001: Database Selection and Scalability
│   ├── 022-adr002.md                         ADR-002: Previous architectural decisions
│   ├── 023-adr003-modul-and-extension-mechanisms.md  ADR-003: Platform modules and CDF extension approach
│   └── archimate/                            ArchiMate model files
│
├── 020-development/
│   ├── 010-development-guide.md              General development guide (platform vs application, module concept, entry point)
...
│   ├── 021-security-implementation-guide.md  Technical deep dive into service security
...
│   └── 090-permissions/
│       ├── 010-permission-selectors-user-guide.md  Permission Selectors - Business User Guide
│       └── 020-permission-selectors-developer-guide.md  Permission Selectors - Technical Implementation Guide
│
├── 040-api-reference/
...
│
└── 050-service-applications/
    └── 010-priceprovider/
        └── 010-public-price-api/
...
- [Architecture Overview](010-architecture/010-overview.md) — Goals, features, quality goals, constraints, layer diagram, module architecture, extension architecture
...
- [ADR-003: Module and Extension Mechanisms](010-architecture/023-adr003-modul-and-extension-mechanisms.md) — Platform modules, CDF plugin, entity extension approach

### Development

- [Development Guide](020-development/010-development-guide.md) — Module concept, platform vs application, project structure, where to put new code
...
- [Testing](020-development/030-testing.md) — Unit, integration, and controller test strategies
...
- [Permission Selectors - Business User Guide](030-features/090-permissions/010-permission-selectors-user-guide.md) — Non-technical guide for permission-based access control
- [Permission Selectors - Technical Guide](030-features/090-permissions/020-permission-selectors-developer-guide.md) — Implementation, architecture, and developer guide

### API Reference

- [General Concepts](040-api-reference/010-general-concept.md) — Typical REST call patterns
- [Error Codes](040-api-reference/020-error-codes.md) — Error response format, HTTP status codes

### Service Applications

- [Public Price API - Integration Guide](050-service-applications/010-priceprovider/010-public-price-api/010-integration-guide.md) — API for external consumers
- [Public Price API - Developer Guide](050-service-applications/010-priceprovider/010-public-price-api/020-developer-guide.md) — Architecture, strategies, extensibility

## Quick Links

| Task | Document |
|------|----------|
| Understanding the module structure | [Development Guide](020-development/010-development-guide.md) |
| Understanding the architecture | [Architecture Overview](010-architecture/010-overview.md) |
| Why platform modules exist | [ADR-003](010-architecture/023-adr003-modul-and-extension-mechanisms.md) |
| Adding a new entity to the platform | [Development Guide](020-development/010-development-guide.md) + [Data Access Layer](020-development/011-development-guide-data-access-layer.md) |
...
| Using the public price API | [Public Price API - Integration Guide](050-service-applications/010-priceprovider/010-public-price-api/010-integration-guide.md) |
